function watershed_marker_controlled(rgb, regiaoInteresse, diretorio_categoria, numImagem)
...
%     imshow(bw), title('Thresholded opening-closing by reconstruction (bw)')
    ...
    result = double(bw) .* regiaoInteresse;
% imshow(Im_seg)

    % Diretório para gravar as imagens segmentadas
    dir_watershed = [diretorio_categoria 'segmentadas\watershed\'];
    ...
    % ROI obtido
    dir_watershed_roi = [diretorio_categoria 'segmentadas\watershed\roi\'];
